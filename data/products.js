...
class Clothing extends Products {
    ...
    getExtraInfoURL() {
        return `<a href="${this.sizeChartLink}" target="__blank">Size chart</a>`;
    }
}
...
class Appliances extends Products {
    ...
    constructor(productDetails) {
        ...
        this.warrentyInfoLink = productDetails.warrentyInfoLink;
    }

    getExtraInfoURL() {
        return `<a href="${this.instructionsLink}" target="__blank">Instructions</a> <a href="${this.warrentyInfoLink}" target="__blank">Warrenty</a> `;
    }
}
...
/* export const products = [
    ...
    },
    {
        ...
        warrentyInfoLink: "images/appliance-warranty.png",
    },
    {
